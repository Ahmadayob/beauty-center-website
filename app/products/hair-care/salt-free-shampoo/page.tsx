...
export default function SaltFreeShampooPage() {
  const [lang, setLang] = useState<"en" | "ar">("en");

  const content = {
    en: {
      title: "Salt Free Shampoo",
      subtitle: "For Damaged & Colored Hair",
      breadcrumb: "Home › Learn More › Hair Products › Hair Care › Salt Free Shampoo",
      description: "Salt free Shampoo from MORIA gently cleanses hair while nourishing it with betaine and keratin proteins, along with calendula and avocado extracts to moisturize. It contains silk amino acids and Rich botanicals like avocado oil, argan oil, and sweet almond oil to hydrate, strengthen, and soften hair, leaving it healthy and manageable. Added panthenol and vitamin E nourishing and soothing your scalp and lock in natural shine. This formula is free of harsh sulfates that can damage hair color, leaving hair feeling healthy, soft and manageable.",
      howToUse: "Wet hair thoroughly. Apply shampoo and massage gently into scalp and hair. Work into a rich lather. Rinse thoroughly with warm water. Follow with conditioner for best results.",
    ...
    ar: {
      title: "شامبو خالٍ من الأملاح",
      subtitle: "للمتضرر والمصبغ",
      breadcrumb: "الرئيسية › تعلم المزيد › منتجات الشعر › العناية بالشعر › شامبو خالٍ من الأملاح",
      description: "شامبو خالٍ من الأملاح من موريا ينظف الشعر بلطف بينما يغذيه بالبيتين وبروتينات الكيراتين، إلى جانب مستخلصات الآذريون والأفوكادو للترطيب. يحتوي على أحماض أمينية من الحرير ونباتات غنية مثل زيت الأفوكادو وزيت الأرجان وزيت اللوز الحلو لترطيب وتقوية وتنعيم الشعر، مما يتركه صحياً وقابلاً للتمشيط. مضاف البانثينول وفيتامين E لتغذية وتهدئة فروة الرأس وإغلاق اللمعان الطبيعي. هذه التركيبة خالية من الكبريتات القاسية التي يمكن أن تضر بلون الشعر، مما يترك الشعر يشعر بالصحة والنعومة والقابلية للتمشيط.",
      howToUse: "بلل الشعر جيداً. ضع الشامبو ودلك برفق في فروة الرأس والشعر. اعمل رغوة غنية. اشطف جيداً بالماء الدافئ. اتبع بالبلسم للحصول على أفضل النتائج.",
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="/#contact" className="text-gray-400 hover:text-gold-600 transition-colors duration-300">Contact</a></li>
              </ul>
            </div>
            <div>
