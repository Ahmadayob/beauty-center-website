...
export default function FacialSunscreenSPF30Page() {
  ...
  const content = {
    ...
    ar: {
      title: "واقي الشمس للوجه (SPF 30)",
      breadcrumb: "الرئيسية › تعلم المزيد › منتجات البشرة › واقي الشمس › واقي الشمس للوجه (SPF 30)",
      productDetail: "واقي الشمس من موريا الذي يجمع بين الفعل الفيزيائي والكيميائي، يحمي بشرتك من الأشعة الضارة للشمس بصيغة خفيفة الوزن وغير مرئية تشعر وكأنها لا شيء ولكنها تعمل كحقل قوة واقي. يتميز بـ 2% أكسيد الزنك و 2% ثاني أكسيد التيتانيوم، يوفر حماية واسعة الطيف UVA/UVB من SPF 30+ للحفاظ على بشرتك آمنة من الشيخوخة المبكرة وأضرار الشمس. المزيج المعدني يحمي بشرتك بشكل طبيعي، ويعكس أشعة الشمس قبل أن تسبب ضرراً. الصيغة المختلطة مثالية للبشرة الحساسة وتوفر مظهراً شفافاً بالكاد ملحوظاً.",
      howToUse: "غير محدد",
