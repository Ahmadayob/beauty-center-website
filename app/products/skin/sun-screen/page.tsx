...
export default function SunScreenPage() {
  ...
  const content = {
    en: {
      title: "Sun Screen",
      breadcrumb: "Home › Learn More › Skin Products › Sun Screen",
      products: [
        {
          id: "facial-sunscreen-spf30",
          title: "Facial Sunscreen (SPF 30)",
          image: "/images/170.jpg"
        },
        {
          id: "facial-sunscreen-spf50",
    ...
    ar: {
      title: "واقي الشمس",
      breadcrumb: "الرئيسية › تعلم المزيد › منتجات البشرة › واقي الشمس",
      products: [
        {
          id: "facial-sunscreen-spf30",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              {lang === "en" 
                ? "Advanced facial sun protection with both physical and chemical actions for comprehensive UV protection"
                : "حماية شمسية متقدمة للوجه تجمع بين الفعل الفيزيائي والكيميائي للحماية الشاملة من الأشعة فوق البنفسجية"
              }
            </p>
          </div>
            ...
            {t.products.map((product, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  {/* View Details Button */}
                  <a 
                    href={`/products/skin/sun-screen/${product.id}`}
