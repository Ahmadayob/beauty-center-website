...
export default function MineralSunscreen183Page() {
  const [lang, setLang] = useState<"en" | "ar">("en");

  const content = {
    en: {
      title: "Mineral Sunscreen (SPF 50) - Tone 1",
      breadcrumb: "Home › Learn More › Skin Products › Mineral Sun Block › Mineral Sunscreen (SPF 50) - Tone 1",
    ...
    ar: {
      ...
      breadcrumb: "الرئيسية › تعلم المزيد › منتجات البشرة › واقي الشمس المعدني › واقي الشمس المعدني (SPF 50) - اللون الأول",
