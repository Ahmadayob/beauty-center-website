...
export default function MineralSunscreen184Page() {
  const [lang, setLang] = useState<"en" | "ar">("en");

  const content = {
    en: {
      title: "Mineral Sunscreen (SPF 50) - Tone 2",
      breadcrumb: "Home › Learn More › Skin Products › Mineral Sun Block › Mineral Sunscreen (SPF 50) - Tone 2",
    ...
    ar: {
      ...
      breadcrumb: "الرئيسية › تعلم المزيد › منتجات البشرة › واقي الشمس المعدني › واقي الشمس المعدني (SPF 50) - اللون الثاني",
