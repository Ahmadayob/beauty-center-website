...
export default function MineralSunBlockPage() {
  const [lang, setLang] = useState<"en" | "ar">("en");

  const content = {
    en: {
      title: "Mineral Sun Block",
      breadcrumb: "Home › Learn More › Skin Products › Mineral Sun Block",
      products: [
        {
          id: "mineral-sunscreen-183",
          title: "Mineral Sunscreen (SPF 50) - Tone 1",
          image: "/images/183.jpg"
        },
        {
          id: "mineral-sunscreen-184",
          title: "Mineral Sunscreen (SPF 50) - Tone 2",
          image: "/images/184.jpg"
        },
        {
          id: "mineral-sunscreen-185",
    ...
    ar: {
      title: "واقي الشمس المعدني",
      breadcrumb: "الرئيسية › تعلم المزيد › منتجات البشرة › واقي الشمس المعدني",
      products: [
        {
          id: "mineral-sunscreen-183",
          title: "واقي الشمس المعدني (SPF 50) - اللون الأول",
          image: "/images/183.jpg"
        },
        {
          id: "mineral-sunscreen-184",
          title: "واقي الشمس المعدني (SPF 50) - اللون الثاني",
          image: "/images/184.jpg"
        },
        {
          id: "mineral-sunscreen-185",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              {lang === "en" 
                ? "Complete mineral sun protection system with SPF 50, available in three flattering tones for all skin types"
                : "نظام حماية شمسية معدني كامل مع SPF 50، متوفر بثلاثة ألوان جذابة لجميع أنواع البشرة"
              }
            </p>
          </div>
            ...
            {t.products.map((product, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  {/* View Details Button */}
                  <a 
                    href={`/products/skin/mineral-sun-block/${product.id}`}
