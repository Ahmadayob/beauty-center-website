...
export default function FoamingCleanserOilyPage() {
  const [lang, setLang] = useState<"en" | "ar">("en");

  const content = {
    en: {
      title: "Foaming Facial Cleanser (Oily Skin)",
      breadcrumb: "Home › Learn More › Skin Products › Cleansers, Toner and Micellars › Foaming Facial Cleanser (Oily Skin)",
      productDetail: "Foaming Facial Cleanser for Oily Skin works hard to give you a deep clean without stripping your skin. The formula uses a blend of AHAs like lactic and glycolic acids, as well as BHAs like salicylic acid, to gently exfoliate away debris and excess oil that can clog pores. Hamamelis extract and vitamin B3 work as natural astringents to minimize the look of pores, while arginine and allantoin help soothe and condition skin so it remains balanced after cleansing.",
      howToUse: "undefined",
    ...
    ar: {
      ...
      breadcrumb: "الرئيسية › تعلم المزيد › منتجات البشرة › منظفات، تونر وميسيلار › منظف الوجه الرغوي (البشرة الدهنية)",
      productDetail: "يعمل منظف الوجه الرغوي للبشرة الدهنية بجد لإعطائك تنظيفاً عميقاً دون تجريد بشرتك. تستخدم الصيغة مزيجاً من AHAs مثل أحماض اللاكتيك والجليكوليك، بالإضافة إلى BHAs مثل حمض الساليسيليك، لتقشير الحطام والزيوت الزائدة التي يمكن أن تسد المسام بلطف. يعمل مستخلص الهاماميليس وفيتامين B3 كقابضات طبيعية لتقليل مظهر المسام، بينما يساعد الأرجينين والألانتوين على تهدئة وترطيب البشرة حتى تبقى متوازنة بعد التنظيف.",
      howToUse: "غير محدد",
