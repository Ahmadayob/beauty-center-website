...
export default function FacialSerumsPage() {
  const [lang, setLang] = useState<"en" | "ar">("en");

  const content = {
    en: {
      title: "Facial Serums",
      breadcrumb: "Home › Learn More › Skin Products › Facial Serums",
      products: [
        {
          id: "vitamin-c-serum",
    ...
    ar: {
      title: "سيرومات الوجه",
      breadcrumb: "الرئيسية › تعلم المزيد › منتجات البشرة › سيرومات الوجه",
      products: [
        {
          id: "vitamin-c-serum",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              {lang === "en" 
                ? "Concentrated serums for targeted skin treatments with advanced active ingredients"
                : "سيرومات مركزة لعلاجات البشرة المستهدفة مع مكونات نشطة متقدمة"
              }
            </p>
          </div>
            ...
            {t.products.map((product, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  {/* View Details Button */}
                  <a 
                    href={`/products/skin/facial-serums/${product.id}`}
