...
export default function HydraRestoreCreamPage() {
  const [lang, setLang] = useState<"en" | "ar">("en");

  const content = {
    en: {
      title: "Hydra Restore Cream (Normal to Dry skin)",
      breadcrumb: "Home › Learn More › Skin Products › Be Youth Facial Care › Hydra Restore Cream",
      productDetail: "This advanced formula from MORIA harnesses the power of vitamins, oils and plant extracts to deeply hydrate and restore dry, parched skin. The inchi oil and jojoba oil blend forms an invisible moisture barrier that locks in hydration, while vitamin C and E help repair damaged skin cells and boost collagen production. Squalene, derived from olives, replenishes skin's natural oils for a healthy glow. Bakuchiol, an alternative to retinol, gently exfoliates to reveal smoother, younger-looking skin. And Matrixyl 3000 targets signs of aging by stimulating the production of new elastin and collagen Fibers.",
      ...
      ingredients: "Water, Propandiol, Triheptanoin, Cetyl Alcohol, Plukenetia volubilis seed oil, Glyceryl Setearate, Simmondsia Chinensis (Jojoba) Seed Oil, Squalane, Glycerin, Peg-75 Stearate, Cetyl Stearate, Niacinamide, 3-O- Ethxy Ascorbic Acid, Ethoxydiglycol, Sodium Hyaluronate, Palmitoyl Tetrapeptide 7, Palmitoyl Tripeptide-1, Tocopherol, Steareth-20, Cetete-20, Butylene Glycol, Isostearyl Isostearate, Potassium Cetyl Phosphate, Bakuchiol, Panthenol, Caprylyl Glycol, Phenoxyethanol, Chlorphenesin, Fragrance, Ascorbyl Tetraisopalmitate, Disodium EDTA, BHT, Stearic Acid, Polysorbate 20, Carbomer."
    },
    ar: {
      title: "كريم هايدرا ريستور (البشرة العادية إلى الجافة)",
      breadcrumb: "الرئيسية › اعرف المزيد › منتجات البشرة › عناية الوجه الشبابية › كريم هايدرا ريستور",
      productDetail: "هذه الصيغة المتقدمة من MORIA تستغل قوة الفيتامينات والزيوت ومستخلصات النباتات لترطيب واستعادة البشرة الجافة والمجففة بعمق. مزيج زيت الإنكا وزيت الجوجوبا يشكل حاجز رطوبة غير مرئي يحبس الترطيب، بينما فيتامين C وE يساعدان على إصلاح خلايا البشرة التالفة وزيادة إنتاج الكولاجين. السكوالين، المستخرج من الزيتون، يعيد تزويد البشرة بالزيوت الطبيعية للحصول على توهج صحي. الباكوشيول، البديل للريتينول، يقشر بلطف لإظهار بشرة أكثر نعومة ومظهراً شاباً. وMatrixyl 3000 يستهدف علامات الشيخوخة من خلال تحفيز إنتاج ألياف الإيلاستين والكولاجين الجديدة.",
