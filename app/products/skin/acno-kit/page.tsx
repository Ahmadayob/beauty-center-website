...
export default function AcnoKitPage() {
  const [lang, setLang] = useState<"en" | "ar">("en");

  const content = {
    en: {
      title: "Acno Kit",
      breadcrumb: "Home › Learn More › Skin Products › Acno Kit",
      products: [
        {
          id: "acno-moisturizing-cream",
          title: "Acno Moisturizing Cream (Oily Skin)",
          image: "/images/112.jpg"
        },
        {
          id: "acno-rebalance-cream",
        ...
        },
        {
          ...
          image: "/images/113 (1).jpg"
        }
      ]
    },
    ar: {
      title: "طقم حب الشباب",
      breadcrumb: "الرئيسية › تعلم المزيد › منتجات البشرة › طقم حب الشباب",
      products: [
        {
          id: "acno-moisturizing-cream",
        ...
        {
          id: "acno-toner",
          title: "تونر حب الشباب (ماء علاجي للبثور)",
          image: "/images/115.jpg"
        },
        {
          id: "acno-cleanser",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              {lang === "en" 
                ? "Complete acne treatment system designed to fight breakouts, control oil, and restore clear, healthy skin"
                : "نظام علاج حب الشباب الكامل مصمم لمحاربة البثور والتحكم في الدهون واستعادة بشرة صافية وصحية"
              }
            </p>
          </div>
            ...
            {t.products.map((product, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  {/* View Details Button */}
                  <a 
                    href={`/products/skin/acno-kit/${product.id}`}
