...
export default function AntiAgingKitPage() {
  const [lang, setLang] = useState<"en" | "ar">("en");

  const content = {
    en: {
      title: "Anti Aging Kit",
      breadcrumb: "Home › Learn More › Skin Products › Anti Aging Kit",
      products: [
        {
          id: "rejuvenating-day-cream-oily",
          title: "Rejuvenating Day Cream (Oily Skin)",
          image: "/images/120.jpg"
        },
        {
          id: "rejuvenating-day-cream-dry",
        ...
        {
          id: "intensive-rejuvenating-night-cream",
    ...
    ar: {
      title: "طقم مضاد الشيخوخة",
      breadcrumb: "الرئيسية › تعلم المزيد › منتجات البشرة › طقم مضاد الشيخوخة",
      products: [
        {
          id: "rejuvenating-day-cream-oily",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              {lang === "en" 
                ? "Complete anti-aging treatment system designed to rejuvenate, firm, and restore youthful skin"
                : "نظام علاج مضاد الشيخوخة الكامل مصمم لتجديد وتقوية واستعادة بشرة شابة"
              }
            </p>
          </div>
            ...
            {t.products.map((product, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  {/* View Details Button */}
                  <a 
                    href={`/products/skin/anti-aging-kit/${product.id}`}
