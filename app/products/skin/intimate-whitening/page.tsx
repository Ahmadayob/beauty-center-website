...
export default function IntimateWhiteningPage() {
  const { lang, setLang } = useLanguage();

  const content = {
    en: {
      title: "Intimate Whitening",
      breadcrumb: "Home › Learn More › Skin Products › Intimate Whitening",
      products: [
        {
        ...
        {
          id: "intimate-wash-gel",
          title: "Intimate Whitening Wash Gel",
          image: "/images/341.jpg"
        },
        {
          id: "whitening-body-scrub",
          title: "Whitening Body Peeling Scrub",
          image: "/images/343.jpg"
        },
        {
          id: "whitening-body-lotion",
          title: "Whitening Body Lotion",
          image: "/images/342 (1).jpg"
        }
      ]
    },
    ar: {
      title: "تبييض المناطق الحساسة",
      breadcrumb: "الرئيسية › تعلم المزيد › منتجات البشرة › تبييض المناطق الحساسة",
      products: [
        {
          id: "intimate-whitening-cream",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              {lang === "en" 
                ? "Specialized intimate care products for gentle whitening and skin brightening in sensitive areas"
                : "منتجات العناية الحميمة المتخصصة للتبييض اللطيف وتفتيح البشرة في المناطق الحساسة"
              }
            </p>
          </div>
            ...
            {t.products.map((product, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  {/* View Details Button */}
                  <a 
                    href={`/products/skin/intimate-whitening/${product.id}`}
